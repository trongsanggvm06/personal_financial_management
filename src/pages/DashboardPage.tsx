...
// One point of the 6-month cash-flow series. `key` is the "YYYY-MM" bucket and
// `label` the short "ThN" tick; SpendingChart consumes income/expense.
...
function buildSeries(transactions: Transaction[]): SeriesPoint[] {
    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
        <StatCard
          ...
          tone={(activeAccount.balance ?? 0) >= 0 ? 'up' : 'down'}
        />
        <StatCard
