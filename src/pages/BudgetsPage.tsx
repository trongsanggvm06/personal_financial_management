...
function BudgetModal({ open, onClose, onSaved, month, existingCategories }: BudgetModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError((err as Error).message || 'Không lưu được ngân sách.');
    } finally {
      setSaving(false);
    }
  };
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        if (!cancelled) setError((err as Error).message || 'Không tải được ngân sách.');
      } finally {
