...
import type { Account, Transaction, TransactionPayload, TransactionStatus } from '../../types';
...
export default function NewTransactionModal({
  ...
  const [status, setStatus] = useState<TransactionStatus>(initial?.status || 'Completed');
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError((err as Error).message || 'Không lưu được giao dịch.');
    } finally {
      setSubmitting(false);
    }
  };
