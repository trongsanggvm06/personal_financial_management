...
export const isIncomeCategory = (category) => INCOME_CATEGORIES.includes(category);
...
export const colorFor = (category) => CATEGORY_COLORS[category] || '#71717a';
export const dotFor = (category) => CATEGORY_DOT[category] || 'bg-zinc-400';
